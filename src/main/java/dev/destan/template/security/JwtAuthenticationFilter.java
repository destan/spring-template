...
public class JwtAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
	...
	private static final class BearerTokenRequestMatcher implements RequestMatcher { //TODO restrict to only /api
		...
		public String toString() {
			// Used to log in org.springframework.security.web.authentication.AbstractAuthenticationProcessingFilter#requiresAuthentication
			return "Has Authorization header";
		}
	}
}
